            ...
            >
                ...
                <div className="w-full flex flex-row gap-3">
                    ...
                    <div className="grow">
                        ...
                        className="italic bg-(--full-white) disabled:bg-gray-200 text-black rounded-xl px-3 py-1 outline-none! w-full
                ...
                <div className="flex flex-center gap-5">
                    ...
                    flex flex-center gap- w-35/100 gap-1" onClick={logoutServer} disabled={loading}>
                        {
                            !loading ?
                            <>
                            <div className="aspect-square w-2/10">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M16 17L21 12M21 12L16 7M21 12H9M9 3H7.8C6.11984 3 5.27976 3 4.63803 3.32698C4.07354 3.6146 3.6146 4.07354 3.32698 4.63803C3 5.27976 3 6.11984 3 7.8V16.2C3 17.8802 3 18.7202 3.32698 19.362C3.6146 19.9265 4.07354 20.3854 4.63803 20.673C5.27976 21 6.11984 21 7.8 21H9" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                            </div>
